...
Np = 2 particles contains two water chords and two air chords, compare Fig. 1 in Kramer et al. (2019). A value between Np = 2 and 5 was used for synthetic signals and real two-phase flow signals, respectively. 
