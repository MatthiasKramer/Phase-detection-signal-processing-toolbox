...
- **R<sub>xy,max</sub>**: threshold of the maximum cross-correlation coefficient. A value between R<sub>xy,max</sub> = 0.5 to 0.7 is recommended, as indicated in Matos et al. (2002, [DOI](https://doi.org/10.1061/40655(2002)58)) and André et al. (2003, [DOI](https://doi.org/10.1061/(ASCE)0733-9429(2005)131:5(423))). 
...
Daniel Valero, IHE Delft Institute for Water Education, Delft, Netherlands. Mail: valero@fh-aachen.de, [ORCID](http://orcid.org/0000-0002-7127-7547)
