...
The code was written in Matlab R2017a. The folder contains source code files and a represetative spillway data set:
...
Daniel Valero, IHE Delft Institute for Water Education
