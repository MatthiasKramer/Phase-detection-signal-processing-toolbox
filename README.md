...
- A greater number of bubble/droplets impact the tips during periods of high velocities. 

This topic is currently being investigated and it is anticipated that the measurement accuracy decreases in regions with relatively high velocity fluctuations. 
